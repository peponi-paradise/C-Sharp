...
#nullable enable
    ...
    protected virtual void ExecutionChanged(object? sender, ExecutionData e) => StepExecutionChanged?.Invoke(sender, e);

    protected virtual void MappedContextsExecutionChanged(object? sender, ExecutionData e)
    {
