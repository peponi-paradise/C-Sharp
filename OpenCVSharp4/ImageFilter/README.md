<h1 id="title">C# - OpenCVSharp4 - Image Filtering</h1>

<h2 id="intro">Introduction</h2>

1. `OpenCV`에서 제공하는 filter를 이용해 필터 또는 샤프닝 효과를 얻을 수 있다.
2. `Filter2D()`, `BoxFilter()` 등 여러 method를 상황에 따라 사용한다.
3. 수행 결과와 예시 코드는 아래 참조

<br><br>

<h2 id="result">수행 결과 확인</h2>

1. Original<br>![Original](Original.png)<br><br>
2. Filter2D<br>![Filter2D](Filter2DResult.png)<br><br>
3. BoxFilter<br>![BoxFilter](BoxFilterResult.png)<br><br>
4. GaussianBlur<br>![GaussianBlur](GaussianResult.png)<br><br>
5. MedianBlur<br>![MedianBlur](MedianResult.png)<br><br>
6. BilateralFilter<br>![BilateralFilter](BilateralResult.png)<br><br>
